...
function Sidebar() {
  ...
  const [bgInitial, setBgInitial] = useState("#ced4da");
  ...
  const handleRadioboxChangeButtonOnce = (e) => {
    ...
    if (e.target.value === "popuponcebutton") {
  ...
  const handleSubmit = async (e) => {
    ...
    const postRequest = await window.api
      .post(`/${value}?shop=${window.shop}`, popupData)
      .then(() => {
        clearData();
      })
  ...
  const handleRadioButton = (e) => {
    setCheckedAllPages(e.target.value);
  };
  ...
  const handleClick = () => {
    try {
      const data = window.api.get(`/check12?shop=${window.shop}`);
                        ...
                        <div className="col-12 col-md-6 add-image">
                          <div className=" ">
                            ...
                            <input
                              ...
                              // placeholder="300"
                              type="number"
                              onChange={(e) => handleImageHeight(e)}
                            />
                          </div>
                        </div>
                        <div className=" col-12 col-md-6 add-image">
                      ...
                      <div className="row  row-margin">
                        <div className="col-12">
                          ...
                          <input
                            ...
                            placeholder="Add your popup heading"
                            ...
                            <li>
                              <div className="">
                                ...
                                <input
                                  ...
                                  placeholder="300"
                                  type="number"
                                  onChange={(e) => handleTitleWeight(e)}
                                />
                              </div>
                            </li>
                            <li>
                              <div className="">
                                ...
                                <div>
                                  <InputColor
                                    ...
                                    initialValue={initialTitleColor}
                            ...
                            <li>
                              <div className="">
                                ...
                                <input
                                  ...
                                  placeholder="300"
                                  type="number"
                                  onChange={(e) => handleMessageWeight(e)}
                                />
                              </div>
                            </li>
                            <li>
                              <div className="">
                                ...
                                <input
                                  ...
                                  placeholder="20"
                                  type="number"
                                  onChange={(e) => handleMessageSize(e)}
                                />
                              </div>
                            </li>
                            <li>
                              <div className="">
                                ...
                                <InputColor
                                  ...
                                  initialValue={initialMessageColor}
